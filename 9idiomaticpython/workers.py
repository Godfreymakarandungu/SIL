...
Emp3 = Employes_first('Wanyama',41,90000)
...
Dev2 = Developers('Mathenge',41,67000,'Java')
Dev3 = Developers('Joana',41,930000,'C++')
Dev4 = Developers('Wambui',41,85000,'Perl')
...
Emp1_third = Employes_extension('Makara','Smith',41,70000)
Emp2_third = Employes_extension('Njogu','Doe',28,90000)
Emp3_third = Employes_extension('Jimmy','Ramone',37,90000)
...
Emp1_forth = Employes_extension_args_kwargs('Robert','Burale',41,70000)
Emp2_forth = Employes_extension_args_kwargs('Jeff','Mike',27,90000)
Emp3_forth = Employes_extension_args_kwargs('Joey','Muthengi',37,90000)
Emp4_forth = Employes_extension_args_kwargs('Tonny','Mathenge',25,90000)
Emp5_forth = Employes_extension_args_kwargs('Jessica','Wambui',37,90000)
